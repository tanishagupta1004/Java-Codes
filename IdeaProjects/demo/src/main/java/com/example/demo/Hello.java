...
public class  extends Application
{
        ...
        vb.getChildren().addAll(l1,tx1,l2,tx2,button,tx3); button.setOnAction(new EventHandler<ActionEvent>()
    {
        ...
        public void handle(ActionEvent arg0)
        {
            ...
            if (userName.equals("TSEC") && password.equals("karan"))
            {
        ...
        Scene scene=new Scene(vb,600,400); primaryStage.setTitle("First JavaFX Application"); primaryStage.setScene(scene); primaryStage.show();
